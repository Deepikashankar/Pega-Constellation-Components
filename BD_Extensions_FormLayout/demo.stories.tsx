...
import BdExtensionsFormLayout from './index';
...
const meta: Meta<typeof BdExtensionsFormLayout> = {
  title: 'BdExtensionsFormLayout',
  component: BdExtensionsFormLayout,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Form'
  }
...
export default meta;
type Story = StoryObj<typeof BdExtensionsFormLayout>;
...
export const BaseBdExtensionsFormLayout: Story = args => {
  const { readOnly } = args;
  ...
  return (
    <>
      <BdExtensionsFormLayout {...props} {...args}>{regionAChildren}</BdExtensionsFormLayout>
    </>
  );
};

BaseBdExtensionsFormLayout.args = {
  readOnly: false,
  showLabel: true,
  label: 'Form template',
  NumCols: 1,
