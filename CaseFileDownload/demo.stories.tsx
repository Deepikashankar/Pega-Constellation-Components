...
import { BdExtnCaseFileDownload } from './index';
...
export default {
  ...
  component: BdExtnCaseFileDownload,
};
...
type Story = StoryObj<typeof BdExtnCaseFileDownload>;
...
export const Default: Story = {
  render: (args) => {
    ...
    return <BdExtnCaseFileDownload {...props} />;
  },
  args: {
    label: 'Launch',
