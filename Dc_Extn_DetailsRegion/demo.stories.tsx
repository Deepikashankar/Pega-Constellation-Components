...
import DcExtnDetailsRegion from './index';
...
const meta: Meta<typeof DcExtnDetailsRegion> = {
  title: 'DcExtnDetailsRegion',
  component: DcExtnDetailsRegion,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Details'
  }
...
export default meta;
type Story = StoryObj<typeof DcExtnDetailsRegion>;
...
export const BaseDcExtnDetailsRegion: Story = (args: any) => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
  ...
  return (
    <DcExtnDetailsRegion {...props} {...args}>
        <Region
          {...{
            getPConnect: () => ({
              setInheritedProp: () => {},
