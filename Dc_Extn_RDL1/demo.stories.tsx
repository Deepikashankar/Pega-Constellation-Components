...
const meta: Meta<typeof DcExtnRdl1> = {
  title: 'DcExtnRdl1',
  component: DcExtnRdl1,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Details'
  }
...
export default meta;
type Story = StoryObj<typeof DcExtnRdl1>;
...
export const BaseDcExtnRdl1: Story = (args: any) => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
