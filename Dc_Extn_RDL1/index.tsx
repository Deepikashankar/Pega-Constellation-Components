...
import StyledDcExtnRdl1Wrapper, { StyledDetailsGridContainer, StyledHighlightedFieldsHrLine } from './styles';

// includes in bundle
import { getAllFields } from './utils';

// interface for props
interface DcExtnRdl1Props extends PConnFieldProps {
...
function DcExtnRdl1(props: DcExtnRdl1Props) {
...
export default withConfiguration(DcExtnRdl1);
