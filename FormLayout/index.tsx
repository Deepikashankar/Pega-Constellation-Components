...
import StyledBdExtensionsFormLayoutWrapper from './styles';

// interface for props
interface BdExtensionsFormLayoutProps extends PConnFieldProps {
...
function BdExtensionsFormLayout(props: BdExtensionsFormLayoutProps) {
  ...
  if (readOnly && readOnly === true || displayMode && displayMode === 'DISPLAY_ONLY') {
    ...
    return (
      <StyledBdExtensionsFormLayoutWrapper>
...
export default withConfiguration(BdExtensionsFormLayout);
