...
import PegaGenericExtensionLayout from './index';
...
const meta: Meta<typeof PegaGenericExtensionLayout> = {
  title: 'PegaGenericExtensionLayout',
  component: PegaGenericExtensionLayout,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Form'
  }
...
export default meta;
type Story = StoryObj<typeof PegaGenericExtensionLayout>;
...
export const BasePegaGenericExtensionLayout: Story = args => {
  const { readOnly } = args;
  ...
  return (
    <>
      <PegaGenericExtensionLayout {...props} {...args}>{regionAChildren}</PegaGenericExtensionLayout>
    </>
  );
};

BasePegaGenericExtensionLayout.args = {
  readOnly: false,
  showLabel: true,
  label: 'Form template',
  NumCols: 1,
