...
import StyledPegaGenericExtensionLayoutWrapper from './styles';

// interface for props
interface PegaGenericExtensionLayoutProps extends PConnFieldProps {
...
function PegaGenericExtensionLayout(props: PegaGenericExtensionLayoutProps) {
  ...
  if (readOnly && readOnly === true || displayMode && displayMode === 'DISPLAY_ONLY') {
    ...
    return (
      <StyledPegaGenericExtensionLayoutWrapper>
...
export default withConfiguration(PegaGenericExtensionLayout);
